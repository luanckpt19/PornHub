...
@Component({
  selector: 'app-notify-message-mng',
  templateUrl: './notify-message-mng.component.html',
  styleUrls: ['./notify-message-mng.component.css']
})
export class NotifyMessageMngComponent implements OnInit {
